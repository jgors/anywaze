...
# Purpose: ingest raw data in flat files into kafka
#----------------------------------------------------------------
...
# city = topic = 'san-francisco'

# connect to Kafka Cluster
# cluster = kafka.KafkaClient("localhost:9092")     # for running the kafka producer on the same node as hdfs master node
